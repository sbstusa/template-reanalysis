...
How can anyone do high stakes data analysis? (Ideas for how to do this on the next slide.)


## General Strategies to Enhance Confidence and Reduce Bugs

1) Work together: 
  a. If you and your colleagues are going to have to use each others' code, you may start writing code as if others were going to read it.
  b. A second pair of eyes spots errors.

2) Test assumptions: Can we get the program to fail when it does something wrong?

3) Track dependencies: What file depends on what other file? Can we go from raw data to results in one command? Where did this figure come from?
  a. Share files instead of copying files.
  b. Think in Batch mode (even if you develop in interactive mode)
